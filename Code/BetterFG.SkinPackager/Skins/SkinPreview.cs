...
namespace BetterFG.Editor
{
    public class SkinPreview
    {
        ...
        private GameObject Spawn(GameObject src)
        {
            ...
            // preview scenes don't tick the normal update loop, so skinning matrices and bounds go
            // stale the moment we rescale the root - only some renderers pick it up, and not until
            // something else forces a full refresh
